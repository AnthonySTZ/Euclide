...
TEST(Transform, TestTranslation) {
    ...
    TransformSettings settings{.translation = {1.0, -5.0, 2.5}};
...
TEST(Transform, TestScale) {
    ...
    TransformSettings settings{.scale = {1.0, -5.0, 2.5}};
...
TEST(Transform, TestRotationAroundYAxis) {
    ...
    TransformSettings settings{.rotation = {0.0, 90.0, 0.0}};
...
TEST(Transform, TestRotationAroundXAxis) {
    ...
    TransformSettings settings{.rotation = {90.0f, 0.0f, 0.0f}};
...
TEST(Transform, TestRotationAroundZAxis) {
    ...
    TransformSettings settings{.rotation = {0.0f, 0.0f, 90.0f}};
...
TEST(Transform, TestRotationCombined) {
    ...
    TransformSettings settings{.rotation = {15.0f, 80.0f, 176.0f}};
