...
static void BM_AXIAGrid1000x1000(benchmark::State& state) { // 33.7 ms - laptop
    ...
    const std::string script = "v@P.y = f@height;";
...
BENCHMARK(BM_AXIAGrid1000x1000)->Unit(benchmark::kMillisecond);