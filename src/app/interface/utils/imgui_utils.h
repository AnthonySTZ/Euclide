...
/// @brief ImGui 2D vector arithmetic operators for convenience.
...
/// @brief Callback to automatically resize a std::string for ImGui InputText widgets.
/// @param data Pointer to ImGui callback data.
...
/// @brief Determines if three points are arranged in counter-clockwise order.
/// @param A First point.
/// @param B Second point.
/// @param C Third point.
/// @return True if points are counter-clockwise, false otherwise.
